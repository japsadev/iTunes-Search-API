...
struct AnimatedAsyncImageView<Content: View, ErrorContent: View, PlaceHolderContent: View>: View {
    ...
    init(imageURL: URL, @ViewBuilder imageView: @escaping (_ image: Image) -> Content, @ViewBuilder errorView: @escaping () -> ErrorContent, @ViewBuilder placeHolderView: @escaping () -> PlaceHolderContent){
