            ...
            AnimatedAsyncImageView(imageURL: songData.bigImageURL) { image in
                VStack{
                    image.resizable()
                        ...
                        .overlay(ClearCircle())
                    HStack{
                        ActionButtonView(isValue: $viewModel.isFavorite, activeIcon: "heart.fill", disActiveIcon: "heart", activeTitle: "Add", disActiveTitle: "Remove") {
                            
                        }
                        ActionButtonView(activeIcon: "heart.fill", activeTitle: "Add") {
