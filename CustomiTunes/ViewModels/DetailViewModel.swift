            ...
            case.success(let data):
                if let song = data{
                    DispatchQueue.main.async {
                        self.detailedSong = DetailViewModel(id: song.trackId!, songName: song.trackName!, singerName: song.artistName!, trackExplicitness: song.trackExplicitness!, songImage: URL(string: song.artworkUrl1000!)!,songPreview: URL(string: song.previewUrl!)!)
                    }
                }
            }
        }
